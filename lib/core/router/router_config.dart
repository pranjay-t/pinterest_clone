...
import 'package:pinterest_clone/features/inbox/presentation/screens/update_screen.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          return CustomTransitionPage(
            key: state.pageKey,
            child: MediaDetailScreen(mediaId: id!, media: media),
            transitionsBuilder:
      ...
      GoRoute(
        path: '/search_input',
        pageBuilder: (context, state) {
          return const NoTransitionPage(child: SearchInputScreen());
        },
      ),
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return SearchResultScreen(
            query: query,
            contextualText: extra?['contextualText'],
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return UpdateScreen(title: title);
        },
      ),
      GoRoute(
        path: '/board_details/:boardId',
        builder: (context, state) {
          final boardId = state.pathParameters['boardId'];
          final boardName = state.extra as String?;
          return MyAllSaveScreen(boardId: boardId, boardName: boardName);
        },
      ),
      GoRoute(
        path: '/saved_media_detail',
        builder: (context, state) {
          final media = state.extra as LocalMediaModel;
          return SavedMediaDetailScreen(media: media);
        },
      ),
    ],
  );
